                            ...
                            <div className="col-md-12">
                                <div className="row">
                                    ...
                                    <div className="col-md-4">
                                        ...
                                        <Button leftIcon={<i className="fa fa-comments-o comment_icon_left" aria-hidden="true"></i>} > Label</Button>
                                    </div>
                                    <div className="col-md-4">
                                        <h5 className="buttonnames">Button with Right Icon</h5>
                                        <Button rightIcon={<i class="fa fa-caret-down dropdown-icon" aria-hidden="true"></i>} >Label </Button>
                                    </div>
                        ...
                        <div className="row">
                            <div className="col-md-12">
                                <div className="row">
                                    ...
                                    <div className="col-md-4">
                                        <h5 className="buttonnames">Button with Right Icon</h5>
                                        <Button type="secondary" rightIcon={<i class="fa fa-caret-down dropdown-icon" aria-hidden="true"></i>} > Label  </Button>
                                    </div>
                        ...
                        <div className="row">
                            <div className="col-md-12">
                                <div className="row">
                                    ...
                                    <div className="col-md-4">
                                        <h5 className="buttonnames">Button with Left Icon</h5>
                                        <Button type="minimal" leftIcon={<i className="fa fa-comments-o comment_icon_left" aria-hidden="true"></i>} >  Label </Button>
                                    </div>
                                    <div className="col-md-4">
                                        <h5 className="buttonnames">Button with Right Icon</h5>
                                        <Button type="minimal" rightIcon={<i class="fa fa-caret-down dropdown-icon" aria-hidden="true"></i>} > Label</Button>
                                    </div>
                        ...
                        <div className="row">
                            <div className="col-md-12">
                                <div className="row">
                                    ...
                                    <div className="col-md-4">
                                        <h5 className="buttonnames">Button with Left Icon</h5>
                                        <Button type="error" leftIcon={<i className="fa fa-comments-o comment_icon_left" aria-hidden="true"></i>} >  Label </Button>
                                    </div>
                                    <div className="col-md-4">
                                        <h5 className="buttonnames">Button with Right Icon</h5>
                                        <Button type="error" rightIcon={<i class="fa fa-caret-down dropdown-icon" aria-hidden="true"></i>} > Label </Button>
                                    </div>
